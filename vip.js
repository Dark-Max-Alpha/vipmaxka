...
${chalk.blue.italic('⚜️⚕️ Connecting to WhatsApp...▶')}`);
    ...
    conn.on('open', async () => {
        ...
        if (conn.user.jid.startsWith('94788306130')) { 
        	
         console.log(chalk.green.bold('USER CONFIRMED 👺')
         );
         }
         
         else if (conn.user.jid.startsWith('94774935916')) { 
         ...
         throw new Error("👺 THIS BOT CAN BE USED ONLY BOT OWNER wa.me/94771039631 ⚜️");
